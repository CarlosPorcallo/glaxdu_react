                                        ...
                                        <ul>
                                            ...
                                            <li className="mega-menu-position top-hover"><a href="shop.html"> SHOP <i className="fa fa-angle-down"></i> </a>
                                                <ul className="mega-menu">
                                                    <li>
                                                        <ul>
                                                            <li className="mega-menu-title"><a href="https://www.youtube.com/watch?v=R1wwopVP7-A">Categories 01</a></li>
                                                    ...
                                                    <li>
                                                        <ul>
                                                            <li className="mega-menu-title"><a href="https://www.youtube.com/watch?v=R1wwopVP7-A">Categories 02</a></li>
                                                            <li><a href="shop.html">bag</a></li>
                                                            <li><a href="shop.html">Pen</a></li>
                                                            <li><a href="shop.html">Erasers</a></li>
                                                            <li><a href="shop.html">Glue sticks</a></li>
                                                    ...
                                                    <li>
                                                        <ul>
                                                            <li className="mega-menu-title"><a href="https://www.youtube.com/watch?v=R1wwopVP7-A">Categories 03</a></li>
                                                            <li><a href="shop.html">bag</a></li>
                                                            <li><a href="shop.html">Pen</a></li>
                                                            <li><a href="shop.html">Erasers</a></li>
                                                            <li><a href="shop.html">Glue sticks</a></li>
                                                    ...
                                                    <li>
                                                        <ul>
                                                            <li className="mega-menu-title"><a href="https://www.youtube.com/watch?v=R1wwopVP7-A">Categories 04</a></li>
                                                            <li><a href="shop.html">bag</a></li>
                                                            <li><a href="shop.html">Pen</a></li>
                                                            <li><a href="shop.html">Erasers</a></li>
                                                            <li><a href="shop.html">Glue sticks</a></li>
                                            ...
                                            <li><a href="https://www.youtube.com/watch?v=R1wwopVP7-A"> PAGES <i className="fa fa-angle-down"></i> </a>
                                                <ul className="submenu">
                                            ...
                                            <ul>
                                                <li className="single-shopping-cart">
                                                    <div className="shopping-cart-img">
                                                        <a href="https://www.youtube.com/watch?v=R1wwopVP7-A"><img alt="" src="assets/img/cart/cart-1.png" /></a>
                                                    </div>
                                                    <div className="shopping-cart-title">
                                                        <h4><a href="https://www.youtube.com/watch?v=R1wwopVP7-A">Color Box </a></h4>
                                                        <h6>Qty: 02</h6>
                                                        <span>$260.00</span>
                                                    </div>
                                                    <div className="shopping-cart-delete">
                                                        <a href="https://www.youtube.com/watch?v=R1wwopVP7-A"><i className="fa fa-times-circle"></i></a>
                                                    </div>
                                                </li>
                                                <li className="single-shopping-cart">
                                                    <div className="shopping-cart-img">
                                                        <a href="https://www.youtube.com/watch?v=R1wwopVP7-A"><img alt="" src="assets/img/cart/cart-2.png" /></a>
                                                    </div>
                                                    <div className="shopping-cart-title">
                                                        <h4><a href="https://www.youtube.com/watch?v=R1wwopVP7-A">Color Box </a></h4>
                                                        <h6>Qty: 02</h6>
